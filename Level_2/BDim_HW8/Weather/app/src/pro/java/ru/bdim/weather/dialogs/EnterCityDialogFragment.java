...
public class EnterCityDialogFragment extends DialogFragment implements Constants {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.btn_open_map:
                        dismiss();
                        restartMainActivity(OPEN_MAP);
                        break;
                    case R.id.btn_ok_enter_city:
                        dismiss();
                        String city = actCity.getText().toString();
                        restartMainActivity(city);
                        break;
                    case R.id.btn_cancel_enter_city:
                        dismiss();
                        break;
                }
            }
        ...
        btnLocation.setOnClickListener(onClick);
        Button btnMap = view.findViewById(R.id.btn_open_map);
