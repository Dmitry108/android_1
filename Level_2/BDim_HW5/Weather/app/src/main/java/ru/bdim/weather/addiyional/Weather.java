...
public class Weather implements Parcelable {
    ...
    public Weather(String city, String date, int temperature, int sky, String skyDescription,
                   float windSpeed, int windDir, int humidity, int pressure) {
        //для получения данных из базы данных
        //нужно выделить работу с интернетом в отдельный класс
        this.city = city;
        this.date = Format.stringToDate(date);
