...
import static ru.bdim.weather.addiyional.Constants.LOCATION;
...
public class SettingsPreference {
    ...
    public boolean getSavedHourly() {
        return preference.getBoolean(HOURLY_PREF, false);
    }
    public boolean getSavedLocation() {
        return preference.getBoolean(LOCAL_PREF, false);
    }
