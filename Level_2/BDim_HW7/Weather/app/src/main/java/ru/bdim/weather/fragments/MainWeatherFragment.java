...
public class MainWeatherFragment extends Fragment implements Observer, Constants {
    ...
    public void onResume() {
        ...
        if (view != null) {
            ...
            if (weather != null) {
                ...
                Objects.requireNonNull(getActivity()).onActivityReenter(BACKGROUND_RESULT_CODE,intent);
                //город
                ...
                imvSky.setImageResource(Format.getImgSky(imvSky, weather.getSky()));
            }
        }
    }
    @Override
